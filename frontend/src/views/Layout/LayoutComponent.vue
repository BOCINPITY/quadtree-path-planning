<template>
  <el-container>
    <el-aside :width="isCollapsed ? '64px' : '150px'">
      <el-menu :default-active="activeMenu" class="el-menu-vertical" :collapse="isCollapsed">
        ...
        <RouterLink to="/system/open_maps_community">
          <el-menu-item index="4" class="menu-item">
            <el-icon>
              <DataAnalysis />
            </el-icon>
            <template #title>开放地图社区</template>
          </el-menu-item>
        </RouterLink>
      ...
      <div @click="toggleCollapse" :class="isCollapsed ? 'collapse-button-closed' : 'collapse-button-opened'"
...
<script lang="ts" setup>
  ...
  watchEffect(() => {
    ...
    if (activeMenu.value === "/system") {
      ...
      activeMenu.value = "3";
    } else if (activeMenu.value === "/system/open_maps_community") {
      activeMenu.value = "4";
    }
  });
</script>
